...
import { IOrderMixin } from "../1inch/limit-order-protocol/OrderMixin.sol";
import { TakerTraits } from "../1inch/limit-order-protocol/libraries/TakerTraitsLib.sol";

import { IResolverExample } from "../1inch/cross-chain-swap/interfaces/IResolverExample.sol";
import { RevertReasonForwarder } from "../solidity-utils/contracts/libraries/RevertReasonForwarder.sol";
import { IEscrowFactory } from "../1inch/cross-chain-swap/interfaces/IEscrowFactory.sol";
import { IBaseEscrow } from "../1inch/cross-chain-swap/interfaces/IBaseEscrow.sol";
import { TimelocksLib, Timelocks } from "../1inch/cross-chain-swap/libraries/TimelocksLib.sol";
import { Address } from "../solidity-utils/contracts/libraries/AddressLib.sol";
import { IEscrow } from "../1inch/cross-chain-swap/interfaces/IEscrow.sol";
import { ImmutablesLib } from "../1inch/cross-chain-swap/libraries/ImmutablesLib.sol";
...
contract Resolver is Ownable {
    ...
    constructor(IEscrowFactory factory, IOrderMixin lop) Ownable() {
        _FACTORY = factory;
        _LOP = lop;
    }
